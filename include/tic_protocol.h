...
#define TIC_INPUT_SCALING_DEGREE_LINEAR 0
#define TIC_INPUT_SCALING_DEGREE_QUADRATIC 1
#define TIC_INPUT_SCALING_DEGREE_CUBIC 2
...
#define TIC_DECAY_MIXED 0
#define TIC_DECAY_SLOW 1
#define TIC_DECAY_FAST 2

#define TIC_PIN_SERIAL_OR_I2C 7
