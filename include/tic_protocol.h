...
#define TIC_STEP_MODE_MICROSTEP2_FULL_CURRENT 6
...
#define TIC_MOTOR_DRIVER_ERROR_OPEN_LOAD 1
#define TIC_MOTOR_DRIVER_ERROR_OVERCURRENT 2
#define TIC_MOTOR_DRIVER_ERROR_OVERTEMPERATURE 3
...
#define TIC_VARIABLES_SIZE 0x5A
