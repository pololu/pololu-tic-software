...
#define TIC_VAR_INPUT_AFTER_AVERAGING 0x4B
#define TIC_VAR_INPUT_AFTER_HYSTERESIS 0x4D
#define TIC_VAR_INPUT_AFTER_FILTERING 0x4F
#define TIC_VARIABLES_SIZE 0x51
