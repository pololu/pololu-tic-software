...
#define TIC_SETTINGS_SIZE 0x61

#define TIC_SERIAL_OPTIONS_BYTE_ENABLE_CRC_FOR_COMMANDS 0
#define TIC_SERIAL_OPTIONS_BYTE_ENABLE_CRC_FOR_RESPONSES 1
#define TIC_SERIAL_OPTIONS_BYTE_ENABLE_7BIT_RESPONSES 2
